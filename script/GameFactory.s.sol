...
contract AnvilEthTransferScript is Script {
    ...
    address public constant WALLET1 =
    ...
    function run() external {
        ...
        require(
            block.chainid == 31337,
            "This script is designed to run on Anvil"
        );
        ...
        console.log(
            "Wallet 1 (%s): %s ETH",
            WALLET1,
            wallet1InitialBalance / 1e18
        );
        console.log(
            "Wallet 2 (%s): %s ETH",
            WALLET2,
            wallet2InitialBalance / 1e18
        );
        ...
        console.log(
            "Sending %s ETH from Wallet 1 to Wallet 2...",
            amountToSend / 1e18
        );
        ...
        console.log(
            "Wallet 1 (%s): %s ETH",
            WALLET1,
            wallet1FinalBalance / 1e18
        );
        console.log(
            "Wallet 2 (%s): %s ETH",
            WALLET2,
            wallet2FinalBalance / 1e18
        );

        console.log("Balance Changes:");
        // For Wallet 1 (which will have a negative change)
        int256 wallet1Change = int256(wallet1FinalBalance) -
            int256(wallet1InitialBalance);
        console.log("Wallet 1: %s ETH", wallet1Change / 1e18);

        // For Wallet 2 (which will have a positive change)
        int256 wallet2Change = int256(wallet2FinalBalance) -
            int256(wallet2InitialBalance);
